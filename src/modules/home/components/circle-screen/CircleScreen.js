...
function CircleFirstPart({scrollRatio}){
    ...
    return <Header2 className={'text-content'} style={headerStyle}>
...
function CircleSecondPart({scrollRatio}){
    ...
    return <>
        <img src={circleActor} alt={'circle-actor'} className={'circle-actor-img'} style={circleAnchorImageStyle}/>
        <Header1 className={'actor-text-content'} style={textStyle}>
            Who do you want to be?
        </Header1>
        <Header3 className={'actor-text-content actor-text-content-secondary'} style={textStyle}>
            Six avatar archetypes.<br/><br/>

            10k Bad Influencers.<br/><br/>
